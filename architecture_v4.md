...
**Mô hình:** Digital-Nervous Level 4 Autonomous Orchestration trên Headless VPS.
...
sequenceDiagram
    ...
    participant Orch as Python Agent Orchestrator<br/>(Digital-Nervous-orchestrator.py)
    ...
    alt Sếp Confirm
        Bash->>Orch: Gọi python3 Digital-Nervous-orchestrator.py<br/>Truyền: PROJECT_ID, TASK, CODE_DIR
...
### 2. Python Agent Orchestrator (`/root/scripts/Digital-Nervous-orchestrator.py`)
...
**Usage:**
```bash
python3 Digital-Nervous-orchestrator.py <PROJECT_ID> <TASK> [CODE_DIR]
```

### 3. ForgeNexus MCP Server (`/root/Digital-Nervous/forgenexus/src/server.ts`)
...
│   ├── Digital-Nervous-orchestrator.py  # MCP Agent Loop
