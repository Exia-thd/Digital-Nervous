...
## Mục tiêu
Track chính xác model usage từ Cursor, Claude Code, Digital-Nervous và các nền tảng khác để hiểu chi phí, tối ưu hóa, và đưa ra recommendations.
...
| Digital-Nervous usage (`~/.Digital-Nervous/usage/`) | Per-skill breakdown | ✅ HIGH |
...
- [ ] Aggregate by model
- [ ] Aggregate by source (cursor, Digital-Nervous, claude-code)
