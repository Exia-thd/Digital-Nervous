...
│                                                                          │
│  ┌─────────────┐   ┌─────────────┐   ┌─────────────┐   ┌───────────┐  │
│  │ Cursor DB   │   │ Claude Tel  │   │ Digital-Nervous │   │ Ollama    │  │
...
### 3. Digital-NervousReader

```python
class Digital-NervousReader:
    """Read from ~/.Digital-Nervous/usage/{project}/*.jsonl"""
    USAGE_PATH = "~/.Digital-Nervous/usage"
...
| `/api/Digital-Nervous/usage` | GET | Digital-Nervous data |
