...
Track AI usage from Cursor, Claude Code, Digital-Nervous into unified dashboard with per-project breakdown. Cross-platform solution for tracking total AI spend.
...
| **Completeness** | 9/10 | Covers all 3 platforms (Cursor, Claude Code, Digital-Nervous), future extensibility |
| **Feasibility** | 9/10 | Readers for Cursor + Digital-Nervous exist, Claude telemetry readable |
...
| **Digital-Nervous** | `~/.Digital-Nervous/usage/*.jsonl` | JSONL | tokens, cost, skill, mode, project |
...
3. **Digital-Nervous**: Full token data available (already working)
...
| Cost estimation accuracy | vs Digital-Nervous actual | ±20% |
