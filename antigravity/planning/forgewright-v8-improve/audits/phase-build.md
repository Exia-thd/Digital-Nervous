...
| QG-03 | P1 | **Regression baseline** — `.Digital-Nervous/baseline-{session}.json` required for brownfield | Ensure baseline captured at session start |
| QG-04 | P2 | **Change manifest format** — `.Digital-Nervous/change-manifest-{session}.json` | Add schema validation |
...
| Finding | Severity | Evidence | Recommendation |
|---------|----------|----------|---------------|
| BS-01 | P1 | **Baseline captured per session** — `.Digital-Nervous/baseline-{session}.json` | Document baseline lifecycle |
