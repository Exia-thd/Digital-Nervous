# Digital-Nervous Game Coordinate System Fix - IMPROVED PLAN v2

## 1. Problem Statement

**Current Issue**: When coding games in Digital-Nervous, frequently unable to accurately identify coordinates to properly position assets.
...
| G5 | Integrate into Digital-Nervous skills | Listed in skill docs |
...
- Digital-Nervous CLI integration
...
#### Task 6.1: Digital-Nervous Skills Integration (1h)
