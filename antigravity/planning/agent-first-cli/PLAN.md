# Plan: Agent-First CLI — Digital-Nervous Integration
...
Digital-Nervous hiện tại là một orchestration system mạnh mẽ với 55 skills, nhưng **thiếu AI-agent-friendly CLI**:
...
1. AI agents có thể discover và invoke Digital-Nervous tools tự động
...
| 2 | User config | `~/.config/Digital-Nervous/config.json` |
...
```markdown
## Migrating to Digital-Nervous CLI v2.0
...
- New: `~/.config/Digital-Nervous/config.json`
...
```markdown
# Digital-Nervous CLI Reference

## Installation
npm i -g Digital-Nervous
...
1. **Internal team** — Use for Digital-Nervous development
