...
Local Memory Client - Digital-Nervous
...
class LocalMemoryClient:
    ...
    COLLECTION_NAME = "Digital-Nervous_memory"
    EMBED_MODEL = "sentence-transformers/all-MiniLM-L6-v2"
    
    def __init__(self, db_path: str = "./.Digital-Nervous/memory_db"):
        ...
        self.collection = self.chroma.get_or_create_collection(
            ...
            metadata={"description": "Digital-Nervous local memory"}
        )
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Digital-Nervous Local Memory CLI",
