#!/usr/bin/env python3
"""
Digital-Nervous Memory Manager v2 — SQLite + FTS5 + RRF Fusion

Storage:
  .Digital-Nervous/memory.db  — SQLite with WAL mode (crash-safe, concurrent reads)
  .Digital-Nervous/memory.db-wal, memory.db-shm — WAL journal files
