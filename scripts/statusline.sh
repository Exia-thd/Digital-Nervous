...
SESSION_LOG="${2:-.Digital-Nervous/session-log.json}"
SETTINGS_FILE="${3:-.Digital-Nervous/settings.md}"
...
format_status() {
    ...
    if $SHORT_MODE; then
        ...
        echo ""
        echo -e "${CYAN}╔════════════════════════════════════════════════════════════╗${NC}"
        echo -e "${CYAN}║${NC} ${BLUE}Digital-Nervous Status${NC}                                              ${CYAN}║${NC}"
        echo -e "${CYAN}╠════════════════════════════════════════════════════════════╣${NC}"
