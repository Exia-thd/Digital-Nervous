...
#
# USAGE:
#   bash Digital-Nervous-update.sh              # Update ForgeWright
#   bash Digital-Nervous-update.sh --migrate    # Force database migration
#   bash Digital-Nervous-update.sh --reindex    # Full re-index after update
#   bash Digital-Nervous-update.sh --check      # Check for updates
# ═══════════════════════════════════════════════════════════════════════════════
...
update_all_indices() {
    ...
    for idx in $indices; do
        ...
        # Skip if it's the Digital-Nervous itself
...
USAGE:
  Digital-Nervous-update.sh [OPTIONS]
...
EXAMPLES:
  ...
  bash Digital-Nervous-update.sh --check

  # Update ForgeWright
  bash Digital-Nervous-update.sh

  # Update + migrate databases + reindex
  bash Digital-Nervous-update.sh --all
EOF
}
