#!/usr/bin/env python3
"""
Digital-Nervous Memory Middleware
============================
...
HOME = Path.home()
MEMORY_DB_DIR = Path(os.environ.get("MEMORY_DB_DIR", f"{HOME}/.Digital-Nervous/sessions"))
SESSION_FILE = MEMORY_DB_DIR / "current-session.json"
SUMMARY_FILE = Path(".Digital-Nervous/subagent-context/CONVERSATION_SUMMARY.md")
...
def main():
    parser = argparse.ArgumentParser(description="Digital-Nervous Memory Middleware")
