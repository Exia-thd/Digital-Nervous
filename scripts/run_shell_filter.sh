...
#
# Priority: rtk > chop > snip > ctx > tkill > Digital-Nervous-shell-filter
#
# This script reads settings from .Digital-Nervous/settings.env if available,
...
detect_compressor() {
    ...
    local settings_file="${Digital-Nervous_DIR:-.}/.Digital-Nervous/settings.env"
    ...
    if command -v rtk &>/dev/null; then
        ...
        echo "Digital-Nervous-shell-filter"
    fi
}
...
run_shell_filter() {
    ...
    case "$compressor" in
        ...
        tkill)
            ...
            ;;
        Digital-Nervous-shell-filter|*)
            local filter_path="${Digital-Nervous_DIR:-.}/scripts/Digital-Nervous-shell-filter.sh"
