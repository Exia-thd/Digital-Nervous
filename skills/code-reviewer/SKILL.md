...
3. Generate auto-fix suggestions for mechanical, unambiguous fixes (missing null checks, auth middleware, input validation, unused imports, missing indexes). Write to `.Digital-Nervous/code-reviewer/auto-fixes/<service>/<file>.patch.md` with before/after code blocks.
...
- Never modify source files — write all output to `.Digital-Nervous/code-reviewer/`
