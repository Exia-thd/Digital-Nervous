...
Maintain per-session state in `.Digital-Nervous/session/asip-state.json`:
...
IF skill completes successfully:
  ...
  5. Update .Digital-Nervous/asip-metrics.json
```
...
│     - Append to .Digital-Nervous/plan-lessons.md OR execution-lessons.md │
│                                                                      │
...
2. Re-read .Digital-Nervous/plan-lessons.md OR execution-lessons.md
...
Update `.Digital-Nervous/asip-metrics.json`:
