...
Context:
- Read shipped product context from: .Digital-Nervous/ship/handoff/
- Read BRD from: .Digital-Nervous/product-manager/BRD/
- Write outputs to: .Digital-Nervous/growth-marketer/
...
Context:
- Read analytics data from: .Digital-Nervous/growth-marketer/analytics-setup.md
- Read product context from: .Digital-Nervous/ship/handoff/
