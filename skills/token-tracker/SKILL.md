...
cat .Digital-Nervous/budget.yaml
...
Tạo `.Digital-Nervous/budget.yaml` để thiết lập ngân sách:

```yaml
# .Digital-Nervous/budget.yaml
budget:
...
```jsonl
{"timestamp":"2026-04-17T10:30:00Z","sessionId":"abc123","project":"Digital-Nervous","projectPath":"/path/to/Digital-Nervous","model":"claude-3-5-sonnet-20241022","provider":"anthropic","inputTokens":1250,"outputTokens":450,"latencyMs":850,"skill":"software-engineer","mode":"feature"}
{"timestamp":"2026-04-17T10:30:05Z","sessionId":"abc123","project":"Digital-Nervous","projectPath":"/path/to/Digital-Nervous","model":"gpt-4o","provider":"openai","inputTokens":980,"outputTokens":320,"latencyMs":720,"skill":"qa-engineer","mode":"test"}
```

### Error Log Format

```jsonl
{"timestamp":"2026-04-17T10:30:00Z","sessionId":"abc123","project":"Digital-Nervous","projectPath":"/path/to/Digital-Nervous","model":"claude-3-5-sonnet-20241022","provider":"anthropic","error":"Rate limit exceeded","errorType":"RateLimitError"}
```
...
| Type | Location |
|------|----------|
| Usage Logs | `~/.Digital-Nervous/usage/{project}/{date}.jsonl` |
| Error Logs | `~/.Digital-Nervous/usage/{project}/errors-{date}.jsonl` |
| Budget Config | `{project}/.Digital-Nervous/budget.yaml` |
| Session Cache | `{project}/.Digital-Nervous/session-log.json` |
...
Skill Action:
1. Kiểm tra .Digital-Nervous/budget.yaml
