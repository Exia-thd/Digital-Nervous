...
详细集成指南见 [.Digital-Nervous/project-manager/mcp/](./.Digital-Nervous/project-manager/mcp/)
...
| 工具 | 模板数量 | 位置 |
|------|----------|------|
| **BASE** | 3 | `.Digital-Nervous/project-manager/templates/BASE/` |
| **Jira** | 5 | `.Digital-Nervous/project-manager/templates/JIRA/` |
| **Linear** | 4 | `.Digital-Nervous/project-manager/templates/LINEAR/` |
| **ClickUp** | 4 | `.Digital-Nervous/project-manager/templates/CLICKUP/` |
| **Asana** | 4 | `.Digital-Nervous/project-manager/templates/ASANA/` |
...
详见 [.Digital-Nervous/project-manager/templates/README.md](./.Digital-Nervous/project-manager/templates/README.md)
...
`.Digital-Nervous/project-manager/excel-generator/`
