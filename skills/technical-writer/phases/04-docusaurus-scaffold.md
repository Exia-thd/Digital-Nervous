...
| Content inventory | `.Digital-Nervous/technical-writer/content-inventory.md` | Sitemap from Phase 1 |
...
Document the chosen approach in `.Digital-Nervous/technical-writer/writing-notes.md`.
...
2. Document the versioning workflow in `.Digital-Nervous/technical-writer/writing-notes.md`:
...
| Writing notes (updated) | `.Digital-Nervous/technical-writer/writing-notes.md` |
