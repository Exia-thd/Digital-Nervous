...
- Prior pipeline artifacts -- any existing `.Digital-Nervous/` outputs from other skills
...
Write all outputs to `.Digital-Nervous/security-engineer/threat-model/`:
