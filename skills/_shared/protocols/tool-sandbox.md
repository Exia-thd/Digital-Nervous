...
└─────────────────────┘
    ...
    │    .Digital-Nervous/audit/{session}/{tool}/{timestamp}.jsonl
    │
    ├──► Sanitize Output
    │    Strip ANSI codes
...
| `FetchMcpResource` | `resource {uri}: {N} chars` | `resource Digital-Nervous://repos: 2048 chars` |
...
tool_sandbox:
  enabled: true
  audit_log_dir: ".Digital-Nervous/audit"
