...
│   The longer you use Digital-Nervous, the SMARTER it becomes.   │
│                                                             │
...
│   │  → Append to .Digital-Nervous/plan-lessons.md                 │   │
...
│   │  → Append to .Digital-Nervous/execution-lessons.md             │   │
...
│   │  → Update .Digital-Nervous/project-profile.json                │   │
│   └─────────────────────────────────────────────────────────────┘   │
└──────────────────────────────────────────────────────────────────────┘
```
...
| **Architectural** | Digital-Nervous skills → Design patterns → Docs |
| **Tooling** | Digital-Nervous protocols → Tool docs → Community |
...
Each project using Digital-Nervous develops:

1. **Project Profile** (`.Digital-Nervous/project-profile.json`)
   - Technology stack learned
   - Common patterns identified
   - Pitfalls encountered
   - Team conventions

2. **Skill Adaptations** (`.Digital-Nervous/skill-adaptations/`)
...
│   project-specific versions stored in .Digital-Nervous/         │
└─────────────────────────────────────────────────────────────┘
```
...
```
✅ GOOD: Append to .Digital-Nervous/plan-lessons.md + skill SKILL.md
...
asip:
  ...
  adaptation:
    storeInProject: true
    skillAdaptationsDir: .Digital-Nervous/skill-adaptations
...
Output to `.Digital-Nervous/asip-metrics.json`:
```json
{
  "projectAdaptation": {
