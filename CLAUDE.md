# Digital-Nervous — Claude Code Integration

> **This file is read by Claude Code on every new chat.** It tells Claude Code how to use Digital-Nervous's production pipeline.
...
2. RESEARCH → Search web, codebase, Digital-Nervous skills, docs
...
| `/mcp` | Generate or check MCP setup — runs `Digital-Nervous-mcp-setup.sh` |
...
1. Detect Digital-Nervous location (standalone, submodule, or Antigravity plugin)
...
```
1. .Digital-Nervous/subagent-context/CONVERSATION_SUMMARY.md
2. ~/.Digital-Nervous/sessions/current-session.json
