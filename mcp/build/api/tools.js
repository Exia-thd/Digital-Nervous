            ...
            tools: [
                {
                    ...
                    description: 'Initialize the Digital-Nervous pipeline for a new project/session. Use this when the user specifies a goal (e.g. Build a SaaS, add a feature).',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            mode: {
                ...
                },
                {
                    ...
                    description: 'Get the current phase of the Digital-Nervous pipeline and its locked status. Use this to determine which skill to load.',
                    inputSchema: {
                        type: 'object',
                        properties: {},
                    },
