 ...
 * 2. User config (~/.config/Digital-Nervous/sandbox.yaml)
 * 3. Project config (.Digital-Nervous/sandbox.yaml)
...
export class ConfigLoader {
  ...
  constructor() {
    ...
    this.projectConfigPath = ".Digital-Nervous/sandbox.yaml";
  }
  ...
  private getDefaultConfig(): SandboxConfig {
    return {
      ...
      monitoring: {
        ...
        auditPath: ".Digital-Nervous/sandbox-audit.jsonl",
        auditMaxSize: "100MB",
        detectEscapeAttempts: true,
        alertOnBypass: true,
        collectMetrics: true,
        metricsPath: ".Digital-Nervous/sandbox-metrics.json",
      },
      features: {
        realTimeBlocking: true,
        autoRollback: false,
