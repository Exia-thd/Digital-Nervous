...
export const SOURCE_LABELS: Record<ConfigSource, string> = {
  ...
  USER_CONFIG: 'User Config (~/.config/Digital-Nervous)',
...
export const CONFIG_PATHS = {
  USER_CONFIG: join(homedir(), '.config', 'Digital-Nervous', 'config.json'),
  LEGACY_CONFIG: join(homedir(), '.Digital-Nervous', 'config.json'),
  LOCAL_ENV: '.env',
...
export class ConfigStore {
  ...
  private loadDefaults(): void {
    ...
    this.set('forge.apiUrl', 'https://api.Digital-Nervous.io', 'DEFAULT');
