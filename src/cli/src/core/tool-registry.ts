/**
 * Digital-Nervous CLI Tool Registry
 *
...
export const TOOL_REGISTRY: readonly ToolSpec[] = [
  // Orchestration
  {
    ...
    description: 'Execute the Digital-Nervous orchestration pipeline',
  ...
  {
    name: 'skills.list',
    description: 'List all available Digital-Nervous skills',
    category: TOOL_CATEGORIES.ORCHESTRATION,
    inputSchema: {
      category: {
        type: 'string',
  ...
  // Validate
  {
    ...
    description: 'Run Digital-Nervous quality gate validation',
    category: TOOL_CATEGORIES.ORCHESTRATION,
    inputSchema: {
      level: {
        type: 'number',
