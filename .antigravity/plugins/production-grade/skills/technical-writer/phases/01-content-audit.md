...
|-------|------|-----------------|
| Business context | `.Digital-Nervous/product-manager/` | User personas, feature scope, domain glossary |
...
| Test artifacts | `tests/`, `.Digital-Nervous/qa-engineer/` | Test coverage, integration test descriptions, test strategy |
| DevOps artifacts | `infrastructure/`, `.github/workflows/` | CI/CD pipelines, deployment configs, environment definitions |
| SRE artifacts | `docs/runbooks/`, `.Digital-Nervous/sre/` | Runbooks, incident procedures, SLO definitions, DR playbooks |
...
| Artifact | Path |
|----------|------|
| Content inventory | `.Digital-Nervous/technical-writer/content-inventory.md` |
| Writing notes and style decisions | `.Digital-Nervous/technical-writer/writing-notes.md` |
