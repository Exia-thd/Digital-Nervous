...
This project is indexed by ForgeNexus as **Digital-Nervous** (2868 symbols, 3021 relationships, 25 execution flows). Use the ForgeNexus MCP tools to understand code, assess impact, and navigate safely.
...
> Digital-Nervous users: The MCP server handles this automatically after `git commit` and `git merge` via PostToolUse hooks.
